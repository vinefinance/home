          ...
          <div className="px-4 max-w-xl mx-auto sm:px-6 lg:py-16 lg:max-w-none lg:mx-0 lg:px-0">
            <div>
              ...
              <div className="mt-6">
                ...
                <div className="mt-6">
                  <a
                    href="https://investopedia.tryvine.xyz"
                    target="_blank"
                    className="inline-flex px-4 py-2 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green-700 hover:bg-blue"
                  >
                    WIP Investopedia
                  </a>
                </div>
