    ...
    <div className="relative pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center">
          <h2 className="text-3xl tracking-tight font-extrabold text-green-700 sm:text-4xl">
            What if <span className="text-white"> Wall Street Bets</span> met{" "}
            <span className="text-white">Acorns Investing</span> in Web3?
          </h2>
        </div>
